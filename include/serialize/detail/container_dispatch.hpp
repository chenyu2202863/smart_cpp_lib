...
namespace serialize { namespace detail {
	...
	template< >
	class container_traits_t<std::pair<const char *, std::uint32_t>>
	{
	public:
	...
	public:
		...
		static void pop(StreamT &io, value_type &val)
		{
			...
			container_traits_t<std::uint32_t>::pop(io, valSize);
	...
	public:
		...
		static void pop(StreamT &io, SequenceTypeT& val)
		{
			...
			container_traits_t<std::uint32_t>::pop(io, val_size);
