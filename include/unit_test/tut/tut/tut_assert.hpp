...
namespace tut
{
    ...
    namespace detail
    {
        template<typename CharT, typename M>
        std::basic_ostringstream<CharT> &msg_prefix(std::basic_ostringstream<CharT> &str, const M &msg)
        {
...
template < typename M, typename CharT >
void ensure_equals(const M& msg, const std::basic_string<CharT>& actual, const std::basic_string<CharT>& expected)
{
	if (expected != actual)
	{
		std::basic_ostringstream<CharT> ss;
...
template <typename M>
void ensure_equals(const M& msg, const char * const actual, const char * const expected)
{
...
template <typename M>
void ensure_equals(const M& msg, const wchar_t * const actual, const wchar_t * const expected)
{
