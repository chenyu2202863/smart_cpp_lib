...
namespace async { namespace service {
		...
		namespace details
		{
			...
			{
				typedef read_handler_t<AsyncWriteStreamT, MutableBufferT, CompletionConditionT, HandlerT>	ThisType;
			...
			{
				typedef read_offset_handler_t<AsyncWriteStreamT, MutableBufferT, OffsetT, CompletionConditionT, HandlerT>	ThisType;
