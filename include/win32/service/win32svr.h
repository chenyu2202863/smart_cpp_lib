...
namespace win32 { namespace service {
	...
	{
	public:
		service_t(LPCTSTR lpszSvrName, LPCTSTR lpszSvrDispName = NULL, LPCTSTR lpszsvrPath = NULL, LPCTSTR lpszSvrDesc = NULL,
	...
	public:
		inline DWORD InstallService()
		{
			return InstallService(m_szSvrName, m_szSvrDispName);
		}
		inline DWORD RemoveService()
		{
			return RemoveService(m_szSvrName);
		}
		inline DWORD StartService()
		{
			return StartService(m_szSvrName);
		}
		inline DWORD StopService()
		{
			return StopService(m_szSvrName);
		}

		static service_t* GetSvrInstance()
		{
			return m_pThis;
		}
		inline LPCTSTR GetSvrName()
		{
			return m_szSvrName;
		}
		inline LPCTSTR GetSvrDispName()
		{
			return m_szSvrDispName;
		}
		inline LPCTSTR GetSvrDesc()
		{
			return m_szSvrDesc;
		}
	...
	public:
		...
		virtual DWORD OnSuspend()
		{
			return ERROR_SUCCESS;
		}
		virtual DWORD OnResume()
		{
			return ERROR_SUCCESS;
		}
		...
		virtual DWORD OnUserDefinedRequest(DWORD dwControl)
		{
			return ERROR_SUCCESS;
		}
		virtual DWORD Run();
	...
	inline service_t* AfxGetWin32Svr()
	{
		return service_t::GetSvrInstance();
	}
}
}
