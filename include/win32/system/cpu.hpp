...
*/
long get_cpu_freq()       //获取CPU频率,单位: MHZ
{
	int start, over;
	_asm
	{
...
inline std::basic_string<CharT> get_cpu_manufacturer()   //获取制造商信息
{
	char manufacturer[25] = {0};

	detail::_Register reg;
	detail::_ExeCPUID(reg, 0);          //初始化
...
*/
template <class CharT>
inline std::basic_string<CharT> get_cpu_name()
{
