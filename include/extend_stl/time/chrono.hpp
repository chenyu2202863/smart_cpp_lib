...
typedef duration<std::uint32_t, ratio<60> > minutes;
typedef duration<std::uint32_t, ratio<3600> > hours;
typedef duration<std::uint32_t, ratio<3600 * 24>> days;
typedef duration<std::uint32_t, ratio<3600 * 24 * 31>> months;
