...
#define ATOMIC_POINTER_LOCK_FREE	\
	(sizeof (void *) <= _ATOMIC_MAXBYTES_LOCK_FREE ? 2 : 0)
...
typedef unsigned _LONGLONG _Uint8_t;
 ...
 void __CLRCALL_PURE_OR_CDECL _Atomic_flag_clear_locking(
	volatile _Atomic_flag_t *, memory_order);
 int __cdecl _Atomic_flag_test_and_set(
	volatile _Atomic_flag_t *, memory_order);
 void __cdecl _Atomic_flag_clear(
	volatile _Atomic_flag_t *, memory_order);
 ...
 void __CLRCALL_PURE_OR_CDECL _Atomic_copy(volatile _Atomic_flag_t *_Flag,
	_CSTD size_t _Size,
	volatile void *_Tgt,
	volatile const void *_Src,
	memory_order _Order);
 void __CLRCALL_PURE_OR_CDECL _Atomic_exchange(volatile _Atomic_flag_t *_Flag,
	_CSTD size_t _Size,
	volatile void *_Tgt,
	volatile void *_Src,
	memory_order _Order);
 ...
 int __CLRCALL_PURE_OR_CDECL _Atomic_compare_exchange_strong(
	...
	memory_order _Order2);
		...
		/* LOCK_FREE PROPERTY */
 int __CLRCALL_PURE_OR_CDECL _Atomic_is_lock_free_1();
 int __CLRCALL_PURE_OR_CDECL _Atomic_is_lock_free_2();
 int __CLRCALL_PURE_OR_CDECL _Atomic_is_lock_free_4();
 int __CLRCALL_PURE_OR_CDECL _Atomic_is_lock_free_8();

		/* LOW-LEVEL LOCK-FREE ATOMIC OPERATIONS */
 void __cdecl _Atomic_store_1(
 ...
 _Uint1_t __cdecl _Atomic_load_1(
 ...
 _Uint1_t __cdecl _Atomic_exchange_1(
	volatile _Uint1_t *, _Uint1_t, memory_order);
 ...
 void __CLRCALL_PURE_OR_CDECL _Atomic_store_2_locking(
 ...
 _Uint8_t __CLRCALL_PURE_OR_CDECL _Atomic_fetch_xor_8_locking(
	volatile _Atomic_flag_t *, _Uint8_t *, _Uint8_t, memory_order);
		...
		/* ATOMIC FENCES */
 void __CLRCALL_PURE_OR_CDECL _Atomic_thread_fence_locking(memory_order);
 void __CLRCALL_PURE_OR_CDECL _Atomic_signal_fence_locking(memory_order);
 void __cdecl _Atomic_thread_fence(memory_order);
 void __cdecl _Atomic_signal_fence(memory_order);
